        ...
        var defaults = {
            ...
            buttons: {
                ...
                delete: {
                    ...
                    html: '<span class="bi bi-trash"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">\n' +
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 10%;">' + toolbar + '</td>');
                    }
                }
            }
        };
